...
web_train = skd.load_files(r"C:\Users\avine\Downloads\A1\dataset\train\cleaned",categories=categories, encoding="ISO-8859-1")
web_test = skd.load_files(r"C:\Users\avine\Downloads\A1\dataset\test\cleaned",categories=categories, encoding="ISO-8859-1")
